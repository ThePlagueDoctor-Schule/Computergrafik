...
// Fraktale.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CFraktaleApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CFraktaleApp::OnAppAbout)
END_MESSAGE_MAP()


// CFraktaleApp-Erstellung

CFraktaleApp::CFraktaleApp() noexcept
{
	...
	SetAppID(_T("Fraktale.AppID.NoVersion"));
